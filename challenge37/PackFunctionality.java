		...
		switch(selectedItem){
			case 1:
				if(pack.addInventoryItem(arrow)){
					System.out.println("Arrow" + itemAdded + msg);
				}
				break;
			case 2:
				if(pack.addInventoryItem(bow)){
					System.out.println("Bow" + itemAdded + msg);
				}
				break;
			case 3:
				if(pack.addInventoryItem(rope)){
					System.out.println("Rope" + itemAdded + msg);
				}
				break;
			case 4:
				if(pack.addInventoryItem(water)){
					System.out.println("Water" + itemAdded + msg);
				}
				break;
			case 5:
				if(pack.addInventoryItem(food)){
					System.out.println("Food" + itemAdded + msg);
				}
				break;
			case 6:
				if(pack.addInventoryItem(sword)){
					System.out.println("Sword" + itemAdded + msg);
				}
				break;
			default:
				System.out.println("not a valid option");
